...
export default function InvalidQrPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0c0a09] flex flex-col items-center justify-center p-6 text-center">
      ...
      <h1 className="text-2xl font-bold text-white mb-2">Could not open table menu</h1>
      <p className="text-white/50 text-sm max-w-md mb-8">
        {detail || 'This QR code is not valid or the server could not be reached. Scan the QR on your table again.'}
      </p>
      <Link
        to="/"
